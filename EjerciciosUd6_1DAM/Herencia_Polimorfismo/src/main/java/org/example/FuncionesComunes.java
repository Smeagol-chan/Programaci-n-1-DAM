...
public class FuncionesComunes
{
     ...
     */
    public static int diaMaximoDelMes(int mes, int any)
    {
        ...
        else if(esBisiesto(any)) return DIA_MAXIMO_28+1;
    ...
    public static char filtroChar(char[] permitidos)
    {
        ...
        do
        {
            ...
            if(!charListado(permitidos.clone(), letra))
            {
    ...
    public static boolean charListado(char[] permitidos, char letraComprobar)
    {
        for(char letraLista : permitidos) if(letraLista == letraComprobar) return true;
        return false;
    }
